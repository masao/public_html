...
\providecommand{\mm}{Matrix Market}
\providecommand{\mw}{行列工房}
\renewcommand{\refname}{参照文献}

\title{``Software Repository''におけるデータの取り扱い\\
{\large --- Matrix Market,行列工房 を例に ---}}
\author{高久 雅生}
\date{1999年3月1日}
\par
...
\begin{figure}
  \begin{center}
   \epsfile{file=index.ps,width=15cm}
...
\begin{figure}
  \begin{center}
   \epsfile{file=MatrixWorkshop.ps,width=12cm}
